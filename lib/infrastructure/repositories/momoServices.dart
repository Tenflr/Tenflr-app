...
// import 'package:college_plan/data/repositories/user_services.dart';

// String urlBaseReal = "http://api.webshinobis.com/api/v1/momo";
...
//   static Future<int> momoCheckOut({String amount, String number}) async {
//     http.Response response = await http.post("$urlBaseReal/checkout", body: {
...
//   static Future<int> momoPayOut({String amount, String number}) async {
//     http.Response response = await http.post("$urlBaseReal/pay", body: {
//       'email': 'fenn25.fn@gmail.com',
//       'password': 'secret',
//       'amount': amount,
//       'phone': number
...
//   static Future<String> momoVerify({String transaction_id}) async {
//     http.Response response =
//         await http.get("$urlBaseReal/verify/$transaction_id", headers: {
//       'email': 'fenn25.fn@gmail.com',
//       'password': 'secret',
//     });
...
//     http.Response response =
//         await http.get("$URL_SAND_PROVISION/apiuser/$apiUser", headers: {
//       "Ocp-Apim-Subscription-Key": PRIMARY_KEY_COLLECTION,
//     });
...
//     http.Response response =
//         await http.post('$URL_COLLECTION_TOKEN/token/', headers: {
